...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/WebExp1/services/HelloWorld";
    ...
    public DefaultNamespace.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.HelloWorldSoapBindingStub _stub = new DefaultNamespace.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.HelloWorldSoapBindingStub _stub = new DefaultNamespace.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "HelloWorld"));
        }
