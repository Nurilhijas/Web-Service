...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="DefaultNamespace.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        DefaultNamespace.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
